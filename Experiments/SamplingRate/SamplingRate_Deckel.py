...
def butter_lowpass(cutoff, fs, order):
    return butter(N=order, Wn=cutoff, fs=fs, btype='low', analog=False)
...
ax[0].plot(df[0:N//2],X_dB[0:N//2],'x')
ax21.plot(df[0:N//2],amplitude_ratio[0:N//2],'r')

ax[1].plot(df[0:N//2],P[0:N//2],'x')
ax22.plot(df[0:N//2],power_ratio[0:N//2],'r')
