...
poly_setpoints = pkl.load(open('./setpoint_models/setpoints/Poly_set_Durchmesser_low_var.pkl','rb'))
poly_setpoints_x0 =    pkl.load(open('./setpoint_models/setpoints_initial_state/Poly_set_x0_Durchmesser_low_var.pkl','rb'))
MLP_setpoints = pkl.load(open('./setpoint_models/setpoints/MLP_set_Durchmesser_low_var.pkl','rb'))
MLP_setpoints_x0 = pkl.load(open('./setpoint_models/setpoints_initial_state/MLP_set_x0_Durchmesser_low_var.pkl','rb'))
...
fig.set_size_inches((8.4/2.54,8/2.54))
# ax.set_xlim([0.8,10.2])
ax.set_ylim([0.7,1])
# ax.set_xticks(range(1,11))

plt.tight_layout()
plt.savefig('Results_Deckel_Durchmesser_low_var.png', bbox_inches='tight',dpi=600)
