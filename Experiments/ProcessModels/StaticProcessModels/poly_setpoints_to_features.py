...
data_train_set,data_val_set  = LoadSetpointData(path,charges,split,targets)
pkl.dump(data_train_set,open('setpoint_data_train.pkl','wb'))
pkl.dump(data_val_set,open('setpoint_data_val.pkl','wb'))

data_train_feat,data_val_feat  = LoadFeatureData(path,charges,split,targets)

pkl.dump(data_train_feat,open('feat_data_train.pkl','wb'))
pkl.dump(data_val_feat,open('feat_data_val.pkl','wb'))
